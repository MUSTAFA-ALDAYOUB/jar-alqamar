...
export const products: Product[] = [
  ...
  { id: "baklava-cigar", name: "سيكار كاجو", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "cigar-cashew"), available: true },
  ...
  { id: "rbat-halabi", name: "وربات حلبي", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "rbat-halabi"), available: true },
  { id: "rbat-qareesh", name: "وربات قريشة", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "rbat-qareesh"), available: true },
  ...
  { id: "molokiya-pistachio", name: "ملوكية فستق", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "molokiya-pistachio"), available: true },

  { id: "harisa-nuts", name: "هريسي مكسرات", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "harisa-nuts"), available: true },
  { id: "baklava-turkish-halabi", name: "بقلاوة تركية حلبي", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "baklava-turkish-halabi"), available: true },
  ...
  { id: "halawet-el-jibn", name: "حلاوة الجبن", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "halawet-el-jibn"), available: true },
  { id: "hrist-al-basha", name: " هريسة الباشا فستق", category: "arabic", price: "السعر لاحقاً", image: img("arabic", "hrist-al-basha"), available: true },

  // =========================
  // معجنات + كريب (داخل المعجنات كما طلبت)
  // =========================
  { id: "maamoul-date", name: "معمول تمر", category: "pastries", price: "5", image: img("pastries", "maamoul-date"), available: true },
  { id: "maamoul-pistachio", name: "معمول فستق", category: "pastries", price: "16", image: img("pastries", "maamoul-pistachio"), available: true },
  { id: "kaak-cheese", name: "كعك جبنة عربي", category: "pastries", price: "10", image: img("pastries", "kaak-cheese"), available: true },
  { id: "barazek-pistachio", name: "برازق فستق", category: "pastries", price: "12", image: img("pastries", "barazek-pistachio"), available: true },

  { id: "karabij-pistachio", name: "كرابيج فستق", category: "pastries", price: "16", image: img("pastries", "karabij-pistachio"), available: true },
  { id: "ghraibeh-arabi", name: "غريبة عربي", category: "pastries", price: "10", image: img("pastries", "ghraibeh-arabi"), available: true },
  { id: "ghraibeh-pistachio", name: "غريبة فستق حلبي", category: "pastries", price: "16", image: img("pastries", "ghraibeh-pistachio"), available: true },
  { id: "mishmisheh-arabi", name: "مشمشية عربي", category: "pastries", price: "8", image: img("pastries", "mishmisheh-arabi"), available: true },
  { id: "tashkilet-ajwat", name: "تشكيلة عجوات", category: "pastries", price: "5", image: img("pastries", "tashkilet-ajwat"), available: true },
  { id: "maamoul-shami", name: "معمول شامي", category: "pastries", price: "16", image: img("pastries", "maamoul-shami"), available: true },
  { id: "petitfour-makbas", name: "بيتيفور مكبس", category: "pastries", price: "5", image: img("pastries", "petitfour-makbas"), available: true },
  { id: "petitfour-sable", name: "بيتيفور سابليه", category: "pastries", price: "10", image: img("pastries", "petitfour-sable"), available: true },
  { id: "simsimiyeh-ajweh", name: "سمسمية عجوة", category: "pastries", price: "5", image: img("pastries", "simsimiyeh-ajweh"), available: true },
